...
from system.views import home, search, request, requestt, recommand, new, registert, login, informationt, register,home_t,information
...
urlpatterns = patterns('',
    ...
    url(r'^request/$', 'system.views.request'),
